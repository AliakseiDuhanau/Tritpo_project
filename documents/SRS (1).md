...
Графический интерфейс представлен в виде [мокапов](https://github.com/AnastasiaKviatsinskaya/tritpo/tree/master/Mockups). <br/>
При запуске приложения пользователь попадает в меню:

![Меню](https://github.com/AnastasiaKviatsinskaya/tritpo/blob/master/Mockups/Меню.png) <br/>

Далее при нажатие на кнопку "Настройки" появляется окно настроек:

![Настройки](https://github.com/AnastasiaKviatsinskaya/tritpo/blob/master/Mockups/Настройки.png) <br/>

При нажатии на кнопку "Начать" в зависимости от выбранного вида тренировки пользователь перейдет к окнам игры:

![Игра1](https://github.com/AnastasiaKviatsinskaya/tritpo/blob/master/Mockups/Начать_тренировка_на_обучение.png) <br/>

![Игра2](https://github.com/AnastasiaKviatsinskaya/tritpo/blob/master/Mockups/Начать_тренировка_на_скорость.png) <br/>
